...
def grayhistogram():
    if root.op==1:
        ...
        histogram(pixels,"Grayscale Value")
        showresult()
...
frame1.grid(row=1, column=0, sticky='ns',padx=5,pady=5)
...
frame3.grid(row=1, column=2, sticky='ns',padx=5,pady=5)

frame4= tk.Frame(root)
frame4.grid(row=1,column=3, sticky='ns')
